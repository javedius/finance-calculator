...
export const metadata: Metadata = {
  title: 'Коммунальные услуги калькулятор 2025 - Расчет ЖКХ платежей',
  description: 'Бесплатный калькулятор коммунальных услуг 2025. Расчет расходов на электричество, воду, отопление, газ, вывоз мусора. Тарифы ЖКХ по регионам России.',
  keywords: [
  ...
  openGraph: {
    title: 'Коммунальные услуги калькулятор 2025 - Расчет ЖКХ платежей',
    description: 'Бесплатный калькулятор коммунальных услуг 2025. Расчет расходов на электричество, воду, отопление, газ, вывоз мусора.',
    type: 'website',
  },
  alternates: {
    canonical: '/utilities',
...
export default function UtilitiesPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Коммунальные услуги калькулятор 2025"
        description="Расчет расходов на электричество, воду, отопление, газ и вывоз мусора"
        icon="⚡"
      />
      <UtilitiesCalculator />
