...
export const metadata: Metadata = {
  title: 'Транспортный налог калькулятор 2025 - Расчет налога на автомобиль',
  description: 'Бесплатный калькулятор транспортного налога 2025. Расчет налога на автомобиль, мотоцикл, автобус по мощности двигателя. Региональные ставки и льготы.',
  keywords: [
  ...
  openGraph: {
    title: 'Транспортный налог калькулятор 2025 - Расчет налога на автомобиль',
    description: 'Бесплатный калькулятор транспортного налога 2025. Расчет налога на автомобиль, мотоцикл, автобус по мощности двигателя.',
    type: 'website',
  },
  alternates: {
...
export default function TransportTaxPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Транспортный налог калькулятор 2025"
