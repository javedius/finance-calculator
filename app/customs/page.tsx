...
export const metadata: Metadata = {
  title: 'Таможенный калькулятор 2024 - Расчет растаможки автомобиля',
  description: 'Бесплатный калькулятор растаможки 2024. Расчет полной стоимости растаможки автомобиля с учетом пошлин, НДС, акциза, утильсбора. Таможенные пошлины ЕАЭС.',
  keywords: [
  ...
  openGraph: {
    title: 'Таможенный калькулятор 2024 - Расчет растаможки автомобиля',
    description: 'Бесплатный калькулятор растаможки 2024. Расчет полной стоимости растаможки автомобиля с учетом пошлин, НДС, акциза, утильсбора.',
    type: 'website',
  },
  alternates: {
    canonical: '/customs',
...
export default function CustomsPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Таможенный калькулятор 2024"
