...
export const metadata: Metadata = {
  title: 'Пенсионные накопления калькулятор 2024 - Расчет будущей пенсии',
  description: 'Бесплатный калькулятор пенсионных накоплений 2024. Расчет будущей пенсии с учетом инвестиций, взносов, инфляции. Планирование пенсионных накоплений онлайн.',
  keywords: [
    ...
    'пенсионный фонд',
    'пенсионные накопления 2024',
    'планирование пенсии',
    'пенсионный калькулятор'
  ],
  openGraph: {
    title: 'Пенсионные накопления калькулятор 2024 - Расчет будущей пенсии',
    description: 'Бесплатный калькулятор пенсионных накоплений 2024. Расчет будущей пенсии с учетом инвестиций, взносов, инфляции.',
    type: 'website',
  },
  alternates: {
...
export default function PensionSavingsPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Пенсионные накопления калькулятор 2024"
        description="Расчет будущих накоплений и пенсионных выплат с учетом инвестиций"
        icon="👴"
      />
