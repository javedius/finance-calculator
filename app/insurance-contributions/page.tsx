...
export const metadata: Metadata = {
  title: 'Страховые взносы калькулятор 2024 - Расчет взносов ИП и самозанятых',
  description: 'Бесплатный калькулятор страховых взносов 2024. Расчет взносов в ПФР, ФСС, ФФОМС для ИП, самозанятых и работодателей. Актуальные ставки и лимиты взносов.',
  keywords: [
  ...
  openGraph: {
    title: 'Страховые взносы калькулятор 2024 - Расчет взносов ИП и самозанятых',
    description: 'Бесплатный калькулятор страховых взносов 2024. Расчет взносов в ПФР, ФСС, ФФОМС для ИП, самозанятых и работодателей.',
    type: 'website',
  },
  alternates: {
...
export default function InsuranceContributionsPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Страховые взносы калькулятор 2024"
