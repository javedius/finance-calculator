...
export const metadata: Metadata = {
  title: 'Налог на имущество калькулятор 2024 - Расчет налога на недвижимость',
  description: 'Бесплатный калькулятор налога на имущество 2024. Расчет налога на недвижимость с учетом типа объекта, региона, льгот. Квартиры, дома, коммерческая недвижимость.',
  keywords: [
    ...
    'налог на имущество 2024',
    'региональные льготы'
  ],
  openGraph: {
    title: 'Налог на имущество калькулятор 2024 - Расчет налога на недвижимость',
    description: 'Бесплатный калькулятор налога на имущество 2024. Расчет налога на недвижимость с учетом типа объекта, региона, льгот.',
    type: 'website',
  },
  alternates: {
...
export default function PropertyTaxPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Налог на имущество калькулятор 2024"
