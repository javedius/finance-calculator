...
export const metadata: Metadata = {
  title: 'Кредитный калькулятор 2024 - Расчет потребительских кредитов онлайн',
  description: 'Бесплатный кредитный калькулятор 2024. Расчет переплат, процентов, досрочного погашения. Потребительские кредиты, автокредиты, рефинансирование. Все банки России.',
  keywords: [
  ...
  openGraph: {
    title: 'Кредитный калькулятор 2024 - Расчет потребительских кредитов онлайн',
    description: 'Бесплатный кредитный калькулятор 2024. Расчет переплат, процентов, досрочного погашения. Потребительские кредиты, автокредиты.',
    type: 'website',
  },
  alternates: {
...
export default function LoansCreditsPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Кредитный калькулятор 2024"
        description="Расчет переплат, процентов и досрочного погашения кредитов"
        icon="💳"
      />
