...
export const metadata: Metadata = {
  ...
  description: 'Финансовый калькулятор - бесплатные онлайн расчеты налогов, ипотеки, кредитов. Актуальные ставки 2025 года. Прогрессивная шкала НДФЛ, страховые взносы, налоги на имущество.',
  keywords: [
  ...
  openGraph: {
    title: 'О проекте - Финансовый калькулятор | Бесплатные онлайн расчеты',
    description: 'Финансовый калькулятор - бесплатные онлайн расчеты налогов, ипотеки, кредитов. Актуальные ставки 2025 года.',
    type: 'website',
  },
  alternates: {
    canonical: '/about',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li>• Актуальные ставки налогообложения 2025 года</li>
        ...
        <Card className="md:col-span-2">
          ...
          <p className="text-gray-600 mb-4">
            С 1 января 2025 года в России действует прогрессивная шкала налогообложения доходов физических лиц. 
