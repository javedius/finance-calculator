...
export const metadata: Metadata = {
  title: 'Доходность инвестиций калькулятор 2025 - Расчет прибыли от инвестиций',
  description: 'Бесплатный калькулятор доходности инвестиций 2025. Расчет прибыли с учетом процентной ставки, налога на прибыль, инфляции. Сложные проценты, реинвестирование.',
  keywords: [
  ...
  openGraph: {
    title: 'Доходность инвестиций калькулятор 2025 - Расчет прибыли от инвестиций',
    description: 'Бесплатный калькулятор доходности инвестиций 2025. Расчет прибыли с учетом процентной ставки, налога на прибыль, инфляции.',
    type: 'website',
  },
  alternates: {
...
export default function InvestmentReturnsPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Доходность инвестиций калькулятор 2025"
        description="Расчет прибыли с учетом процентной ставки и налога на прибыль"
        icon="📈"
      />
