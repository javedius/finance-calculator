...
export const metadata: Metadata = {
  title: 'Ипотечный калькулятор 2025 - Расчет платежей по ипотеке онлайн',
  description: 'Бесплатный ипотечный калькулятор 2025. Рассчитайте ежемесячные платежи, переплату, досрочные погашения. Все банки России. Аннуитетные и дифференцированные платежи.',
  keywords: [
  ...
  openGraph: {
    title: 'Ипотечный калькулятор 2025 - Расчет платежей по ипотеке онлайн',
    description: 'Бесплатный ипотечный калькулятор 2025. Рассчитайте ежемесячные платежи, переплату, досрочные погашения. Все банки России.',
    type: 'website',
  },
  alternates: {
    canonical: '/mortgage',
...
export default function MortgagePage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Ипотечный калькулятор 2025"
