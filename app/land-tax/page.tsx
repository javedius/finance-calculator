...
export const metadata: Metadata = {
  title: 'Земельный налог калькулятор 2024 - Расчет налога на землю',
  description: 'Бесплатный калькулятор земельного налога 2024. Расчет налога на земельный участок с учетом категории, площади, кадастровой стоимости. Льготы и региональные ставки.',
  keywords: [
  ...
  openGraph: {
    title: 'Земельный налог калькулятор 2024 - Расчет налога на землю',
    description: 'Бесплатный калькулятор земельного налога 2024. Расчет налога на земельный участок с учетом категории, площади, кадастровой стоимости.',
    type: 'website',
  },
  alternates: {
    canonical: '/land-tax',
...
export default function LandTaxPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Земельный налог калькулятор 2024"
        description="Расчет налога с учетом категории и площади участка"
        icon="🏞️"
      />
      <LandTaxCalculator />
