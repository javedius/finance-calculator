...
export const metadata: Metadata = {
  title: 'Срок окупаемости калькулятор 2024 - Расчет периода окупаемости',
  description: 'Бесплатный калькулятор срока окупаемости 2024. Расчет периода окупаемости инвестиций, проектов, оборудования. NPV, IRR, дисконтирование.',
  keywords: [
    ...
    'срок окупаемости 2024',
    'финансовый анализ'
  ],
  openGraph: {
    title: 'Срок окупаемости калькулятор 2024 - Расчет периода окупаемости',
    description: 'Бесплатный калькулятор срока окупаемости 2024. Расчет периода окупаемости инвестиций, проектов, оборудования.',
    type: 'website',
  },
  alternates: {
...
export default function PaybackPeriodPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Срок окупаемости калькулятор 2024"
        description="Расчет периода окупаемости инвестиций и проектов"
        icon="📊"
      />
