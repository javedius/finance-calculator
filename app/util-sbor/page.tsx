...
export const metadata: Metadata = {
  title: 'Утилизационный сбор калькулятор 2024 - Расчет утильсбора',
  description: 'Бесплатный калькулятор утилизационного сбора 2024. Расчет утильсбора для автомобилей, мотоциклов, спецтехники. Ставки утилизационного сбора.',
  keywords: [
    'утилизационный сбор калькулятор',
    'утильсбор автомобиль',
    'утильсбор мотоцикл',
    'утилизационный сбор 2024',
    'ставки утильсбора',
  ...
  openGraph: {
    title: 'Утилизационный сбор калькулятор 2024 - Расчет утильсбора',
    description: 'Бесплатный калькулятор утилизационного сбора 2024. Расчет утильсбора для автомобилей, мотоциклов, спецтехники.',
    type: 'website',
  },
  alternates: {
    canonical: '/util-sbor',
...
export default function UtilSborPage() {
  ...
  return (
    <div>
      ...
      <PageHeader
        title="Утилизационный сбор калькулятор 2024"
        description="Расчет утилизационного сбора для автомобилей и спецтехники"
        icon="♻️"
      />
      <UtilSborCalculator />
